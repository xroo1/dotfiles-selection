...
" -----------------------------------------------------------
highlight Normal       guibg=#00000090 guifg=#d0d0d0  " Fundo base
highlight ColorColumn  guibg=#242728               " Colunas destacadas
highlight CursorLine   guibg=#0f0f0f guifg=NONE    " Linha atual
highlight CursorLineNr guibg=#141414 guifg=#ff6b9d  " Número da linha atual (rosa vibrante)
...
" Divisórias
highlight VertSplit    guifg=#000000 guibg=#1B1D1E
highlight WinSeparator guifg=#0f0f0f guibg=#1B1D1E
...
" -----------------------------------------------------------
highlight Directory    guifg=#00e5ff guibg=#0f0f0f
highlight NERDTreeDir  guifg=#00e5ff guibg=#ffffff
...
" -----------------------------------------------------------
highlight NormalFloat  guibg=#2427280 guifg=#d0d0d0
highlight FloatBorder  guibg=#0f0f0f0 guifg=#444444

" -----------------------------------------------------------
" Garantir consistência dos fundos
" -----------------------------------------------------------
highlight Normal       guibg=#1B1D1E0
highlight EndOfBuffer  guibg=#1B1D1E0 
highlight SignColumn   guibg=#0f0f0f0 
highlight LineNr       guibg=#0f0f0f 
highlight CursorLine   guibg=#0f0f0f 
highlight StatusLine   guibg=#0f0f0f 
highlight StatusLineNC guibg=#1F21220
highlight Pmenu        guibg=#2427280 
highlight TabLineSel   guibg=#2427280 
highlight TabLineFill  guibg=#1B1D1E0
highlight ColorColumn  guibg=#0f0f0f0
highlight FoldColumn   guibg=#0f0f0f0
highlight VertSplit    guibg=#1B1D1E0
highlight WinSeparator guibg=#1B1D1E0
highlight NonText      guibg=#1B1D1E0
