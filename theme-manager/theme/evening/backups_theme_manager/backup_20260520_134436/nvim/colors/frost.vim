...
" Versão adaptada do tema claro (day) - Fundo mais escuro harmonizado
...
" -----------------------------------------------------------
" NeoTree fundo = #D5DAE0
" Fundo principal = levemente mais escuro que antes, mantendo contraste
let s:bg_main = "#E4E8EE"      " Fundo principal (mais escuro e suave)
let s:bg_soft = "#DEE2E8"      " Fundo secundário suave
let s:bg_metal = "#D8DCE2"     " Fundo metálico claro
let s:bg_glow = "#D5DAE0"      " Fundo brilho sutil (mesmo do NeoTree)
...
" -----------------------------------------------------------
highlight Normal       guibg=#E4E8EE guifg=#3B4147
highlight ColorColumn  guibg=#DEE2E8
highlight CursorLine   guibg=#DEE2E8 guifg=NONE
highlight CursorLineNr guibg=#D8DCE2 guifg=#8DB9DE gui=bold
highlight Cursor       guibg=#4A90C4 guifg=#F5F7FA

" Coluna de números
highlight LineNr       guibg=#DEE2E8 guifg=#8B939A
highlight LineNrAbove  guibg=#DEE2E8 guifg=#9BA3AB
highlight LineNrBelow  guibg=#DEE2E8 guifg=#9BA3AB
...
highlight StatusLineNC guibg=#D8DCE2 guifg=#8B939A

" Menu suspenso
highlight Pmenu        guibg=#D8DCE2 guifg=#3B4147
highlight PmenuSel     guibg=#4A90C4 guifg=#F5F7FA
highlight PmenuSbar    guibg=#F5F7FA
highlight PmenuThumb   guibg=#6BA5D1

" Divisórias
highlight VertSplit    guifg=#E4E8EE guibg=#E4E8EE
highlight WinSeparator guifg=#D8DCE2 guibg=#E4E8EE
highlight NonText      guifg=#A9B0B7 guibg=#E4E8EE
highlight SignColumn   guibg=#E4E8EE guifg=#3B4147

" Abas
highlight TabLine      guibg=#DEE2E8 guifg=#8B939A
highlight TabLineSel   guibg=#E4E8EE guifg=#8DB9DE gui=bold
highlight TabLineFill  guibg=#E4E8EE
...
highlight Visual       guibg=#D8DCE2 guifg=#3B4147
...
" Outros Elementos
" -----------------------------------------------------------
highlight Folded       guibg=#DEE2E8 guifg=#8B939A
highlight FoldColumn   guibg=#E4E8EE guifg=#9BA3AB
highlight EndOfBuffer  guifg=#E4E8EE guibg=#E4E8EE
...
" Git e versionamento
" -----------------------------------------------------------
highlight GitGutterAdd    guifg=#5A9A8A guibg=#E4E8EE
highlight GitGutterChange guifg=#4A90C4 guibg=#E4E8EE
highlight GitGutterDelete guifg=#8A8ABF guibg=#E4E8EE

" -----------------------------------------------------------
" Exploradores de arquivos
" -----------------------------------------------------------
highlight Directory    guifg=#8DB9DE guibg=#E4E8EE
...
highlight Whitespace   guifg=#DEE2E8 guibg=NONE

" -----------------------------------------------------------
" Áreas flutuantes
" -----------------------------------------------------------
highlight NormalFloat  guibg=#D8DCE2 guifg=#3B4147
highlight FloatBorder  guibg=#E4E8EE guifg=#4A90C4
